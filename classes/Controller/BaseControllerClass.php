...
class BaseControllerClass
{
    ...
    public function handleRequest()
    {
        ...
        switch ($action) {
            ...
            case 'render':
                ...
                $output = $controller->render($outputTitle, $code, $options, $data);
    ...
    public function getInputMediaFilePath($type, $mediaData)
    {
        $inputDirPath = $this->getPublicPath($type . '_dir') . DIRECTORY_SEPARATOR;
