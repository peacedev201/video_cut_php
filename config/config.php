...
$config['upload_images'] = array('jpg', 'jpeg', 'png');
$config['upload_audio'] = array('mp3', 'm4a');
...
$config['admin_auth_email'] = 'demo@demo.com';//Email of the Admin (Facebook or Google account)
$config['user_blocked_default'] = false;//Users blocked by default

$config['facebook_app_id'] = 'xxxxxxxxxxxxxxxxxx';//Facebook App ID
$config['facebook_secret_key'] = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx';//Facebook App Secret

$config['google_client_id'] = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.apps.googleusercontent.com';//Google Client ID
